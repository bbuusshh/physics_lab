...
# Import functions from numpy library for scientific simulation from numpy import pi, linspace,meshgrid,sin
...
class MainApp(QMainWindow , Ui_MainWindow):
    ...
    def fig1(self):
        ...
        # 2D representation
        BB, HH =meshgrid(B,H)
        I=((sin(BB)/BB)**2)*((sin(HH)/HH)**2) #figure 2D
        ...
        mpl.ax.set_title(r"$\lambda = %.3e \ m, \ b = %.2e \ m, \ h = %.2e \ m, \ f_2 = %.1f \ m$"% (lamda,b, h, f_2),
        fontsize =10)
        mpl.draw()
